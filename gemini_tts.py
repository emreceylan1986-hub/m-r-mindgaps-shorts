"""
gemini_tts.py — mindgaps_paneli doğal seslendirme (Leda) (Gemini 2.5 TTS)
...
STIL = ("Narrate in a warm, knowing, gently intriguing tone — like revealing a secret about the mind, clear and calm: ")
