...
# 9 Ağu: sakin/atmosferik havuz (kanal yayını durdurulmuş olsa da lisans hatası
# koda gömülü kalmasın — ileride açılırsa güvenli çalışsın).
ZIHIN_ARAMALAR = [
    "atmospheric drone", "deep ambient", "cinematic ambient",
    "calm drone", "meditation ambient",
]
    ...
    try:
        ...
        if not muzik_var:
            ...
            if not muzik_key:
                ...
                _havuz = _rnd.sample(ZIHIN_ARAMALAR, len(ZIHIN_ARAMALAR))
                muzik_var = False
